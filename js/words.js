...
const wordsDatabase = {
    kids: {
        ...
        hard: [
            ...
            { word: "moth", hint: "It turns into a flying insect" },
            { word: "plane", hint: "Aircraft that flies in the sky" },
    ...
    adults: {
        ...
        hard: [
            { word: "existential void", hint: "The emptiness at the core of being" },
            { word: "cognitive decay", hint: "Deterioration of mental faculties" },
            { word: "temporal abyss", hint: "The infinite darkness of time" },
            { word: "perpetual despair", hint: "Endless state of hopelessness" },
            { word: "ethereal darkness", hint: "Otherworldly manifestation of gloom" },
            { word: "malevolent entropy", hint: "Evil force of gradual destruction" },
            { word: "nocturnal psyche", hint: "Dark aspects of the mind" },
            { word: "morbid serenity", hint: "Peace found in darkness" },
            { word: "spectral silence", hint: "Ghostly absence of sound" },
            { word: "profound malaise", hint: "Deep-seated spiritual sickness" },
            { word: "nebulous horror", hint: "Shapeless form of terror" },
            { word: "visceral dread", hint: "Deep-seated bodily fear" },
            { word: "eternal torment", hint: "Endless suffering of the soul" },
            { word: "decrepit wisdom", hint: "Knowledge gained through decay" },
            { word: "sepulchral voice", hint: "Speech from the grave" },
            { word: "nihilistic truth", hint: "Reality of meaninglessness" },
            { word: "macabre beauty", hint: "Disturbing aesthetic appeal" },
            { word: "peripheral ghost", hint: "Spirit at the edge of vision" },
            { word: "obscure trauma", hint: "Hidden psychological wound" },
            { word: "mercurial fate", hint: "Unpredictable destiny" },
            { word: "aberrant psyche", hint: "Deviant state of mind" },
            { word: "nefarious wisdom", hint: "Knowledge of evil things" },
            { word: "tenebrous mind", hint: "Consciousness filled with shadows" },
            { word: "spectral memory", hint: "Haunting recollection" },
            { word: "moribund dream", hint: "Dying vision of reality" },
            { word: "ephemeral pain", hint: "Fleeting but intense suffering" },
            { word: "nocturnal truth", hint: "Reality revealed in darkness" },
            { word: "perpetual void", hint: "Never-ending emptiness" },
            { word: "malignant peace", hint: "Destructive tranquility" },
            { word: "profound dread", hint: "Deep existential fear" }
        ]
    }
};
